...
<#if Session.auth_user??>
				<div class="btn-group pull-right" id="user_service" uid="${Session.auth_user.id}">
					<a class="btn btn-primary" href="#"><i class="icon-user icon-white"></i> ${Session.auth_user.authorizedName}</a>
					<a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="/resources/notty/html/publication.html"><i class="icon-pencil"></i> 发表信息</a></li>
						<li><a href="/auth_users/${Session.auth_user.id}/modify"><i class="icon-edit"></i> 修改个人信息</a></li>
	<#if Session.auth_user.type == "ADMIN">
...
<#if Session.auth_user??>
	<#if Session.auth_user.id == notice.author.id>
