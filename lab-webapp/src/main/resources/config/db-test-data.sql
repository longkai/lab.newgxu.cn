...
VALUES
    (null, 'ADMIN', '雨无声', '雨无声网站', '雨无声网站官方', '0771-3273880', '2013-07-31',
                0, 'newgxu', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', '龙凯', 'com.gihub.longkai', 'longkai', 'im.longkai@gmail.com', '1991-12-17',
                0, 'longkai', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', 'Steve Jobs', 'Apple Inc.', '乔布斯，苹果公司联合创始人', 'http://apple.com', '1955-2-24',
                0, 'steve_jobs', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', 'Larry Page', 'Google Inc.', '佩奇，Google公司联合创始人', 'http://google.com', '1973-3-26',
                0, 'larry_page', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', 'Bill Gates', 'Microsoft Inc.', '比尔·盖茨，微软公司董事长', 'http://microsoft.com', '1955-10-28',
                0, 'bill_gates', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', 'Mark Zuckerberg', 'Facebook Inc.', '扎克伯格，Facebook社交网站创始人', 'http://facebook.com', '1984-5-14',
                0, 'mark_zuckerberg', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', '马云', 'Alibaba Inc.', '马云，淘宝网创始人', 'http://alibaba.com', '1964-10-15',
                0, 'ma_yun', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

INSERT INTO info_users
    (id, type, authed_name, org, about, contact, join_date,
                blocked, account, password, last_login_ip, last_login_date, last_modified_date)
VALUES
    (null, 'DEFAULT', '马化腾', 'Tencent Inc.', '马化腾，腾讯创始人', 'http://tencent.com', '1971-10-29',
                0, 'mahuateng', '05691cb4127e5cdfc211fbcfc2fd8a0d', null, null, null);

------------------------------------------------

INSERT INTO info_notices
...
INSERT INTO info_notices
       (id, add_date, blocked, click_times, content, doc_name, doc_url, last_modified_date, title, uid)
VALUES
       (null, '2013-5-27', 0, 75, '如今，有来自国外的阿森纳球迷对温格的“所作所为”忍无可忍了，这位枪手死忠甚至在推特上以死相逼！如图所示，这位名叫“Yoann”的阿森纳球迷在推特上发布了一张拿刀架着脖子的图片，像是要刎颈自杀，眼神中充满了哀怨和失望，俨然是在发泄对阿森纳引援不力的不满，他在推特上写道：“温格，如果你下周末之前还不签下苏亚雷斯，那么……”',
...
INSERT INTO info_notices
       (id, add_date, blocked, click_times, content, doc_name, doc_url, last_modified_date, title, uid)
VALUES
       (null, '2013-7-30', 0, 25, '7月31日消息，据国外媒体报道，欧盟反垄断机构日前加大了对谷歌商业行为的审查力度。当局发放问卷询问谷歌的竞争对手：谷歌在搜索引擎上对其给予较低排名，这是否影响到了这些网站的访问人数。',
